...
class _88_MergeSortedArrayTest {
    ...
    static Stream<Arguments> data() {
        return Stream.of(
                ...
                Arguments.of(new int[]{7, 3}, 1, new int[]{1, 4, 6}, 2, new int[]{1, 4, 7}),
                Arguments.of(new int[]{1, 4, 6, 7}, 4, new int[]{2, 3, 5}, 3, new int[]{1, 2, 3, 4, 5, 6, 7})
        );
    }
    ...
    void merge(int[] nums1, int m, int[] nums2, int n, int[] expected) {
        int[] actual = new _88_MergeSortedArray().merge(nums1, m, nums2, n);
